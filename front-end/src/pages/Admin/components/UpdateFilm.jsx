...
const UpdateFilm = () => {
  ...
  const { refreshRemoveFilm, refreshAddFilm, refreshUpdateFilm } = useSelector(
  ...
  const updateFilmContent = (
    <div className="wrapper-content-update-film">
      ...
      >
        ...
        <Form.Item label="Ảnh poster" name="img" initialValue={detailFilm.img}>
          <Input />
        </Form.Item>
        <Form.Item label="Link phim" name="link" initialValue={detailFilm.link}>
          <Input />
        </Form.Item>
        <Form.Item
        ...
        >
          <div className="test">
            ...
            <Button type="primary" className="btn-confirm" htmlType="submit">
              Xác nhận
            </Button>
          </div>
        </Form.Item>
