...
const UpdateFilm = () => {
  ...
  const { refreshRemoveFilm, refreshAddFilm } = useSelector(
    (state) => state.refreshReducer
  );
  ...
  }, [currentCinema, refreshRemoveFilm, refreshAddFilm]);
            ...
            <div className="movie-item" key={index}>
              ...
              <div className="info-movie">
                <div className="title-movie">
                  <div
                    onClick={() => {
                      navigate(`/${currentCinema}/detail-film`);
  ...
  const updateFilmContent = (
    <div className="wrapper-content-update-film">
      ...
      >
        <Form.Item label="Tên phim" name="name" required={true}>
          <Input defaultValue={detailFilm.name} />
        </Form.Item>
        <Form.Item label="Tên viết tắt" name="nameFilm">
          <Input defaultValue={detailFilm.nameFilm} />
        </Form.Item>
        <Form.Item label="Thời lượng (phút)" name="duration">
          <Input defaultValue={detailFilm.duration} />
        </Form.Item>
        <Form.Item label="Thể loại" name="category">
          <Input defaultValue={detailFilm.category} />
        </Form.Item>
        <Form.Item label="Ảnh poster" name="img">
          <Input defaultValue={detailFilm.img} />
        </Form.Item>
        <Form.Item label="Link phim" name="link">
          <Input defaultValue={detailFilm.link} />
        </Form.Item>
        <Form.Item label="Giới hạn độ tuổi" name="age">
          <InputNumber defaultValue={detailFilm.age} />
        </Form.Item>
        <Form.Item label="Tình trạng phim" name="type">
          <Radio.Group defaultValue={detailFilm.type}>
        ...
        <Form.Item label="Chọn rạp" name="nameCinema">
          <Select defaultValue={detailFilm.nameCinema}>
        ...
        <Form.Item label="Đạo diễn" name="director">
          <Input defaultValue={detailFilm.director} />
        </Form.Item>
        <Form.Item label="Diễn viên" name="actor">
          <Input defaultValue={detailFilm.actor} />
        </Form.Item>
        <Form.Item label="Ngôn ngữ" name="language">
          <Select defaultValue={detailFilm.language}>
        ...
        <Form.Item label="Mô tả" name="description">
          <TextArea rows={4} defaultValue={detailFilm.description} />
        </Form.Item>
