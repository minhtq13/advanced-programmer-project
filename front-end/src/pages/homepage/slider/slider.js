            ...
            <div className="container">
                <Slider {...settings}>
                    <div className="slider-box">
                        <div className="box-item slider-3"></div>
                    </div>
                    <div className="slider-box">
                        <div className="box-item slider-1">
                            <div className="box-text">
                                ...
                                >
                                    Giải pháp tiêm chủng kết hợp với quản lý
                                    nhân viên, khách hàng rất thuận tiện
                                </h2>
                                <p
                                ...
                                >
                                    Quản lý toàn diện các thông tin khách hàng,
                                    nhân viên dễ dàng truy cập sửa đổi thông tin
                                </p>
                                {}
                                <a
                                    href="#"
                        ...
                        <div className="box-item slider-2">
                            <div className="box-text">
                                ...
                                <p
                                    ...
                                    title="Quản lý toàn diện quy trình TCDV tại các cơ sở tiêm, đáp ứng nhu cầu quản trị vận hành, đồng thời tăng hiệu suất kinh doanh và chăm sóc khách hàng."
                                >
                                    Linh hoạt trong quản lý thông tin khách hàng
                                    và lịch tiêm chủng được sắp xếp linh hoạt,
